...
The [*Hu 2022* dataset](installation.md) profiles cells from zebrafish hearts at multiple time points.

To see more details regarding the experiment and features of the dataset, please refer to: _Hu, B., Lelek, S., Spanjaard, B., El-Sammak, H., Simoes, M. G., Mintcheva, J., ... & Junker, J. P. (2022). Origin and function of activated fibroblast states during zebrafish heart regeneration. Nature genetics, 54(8), 1227-1237._

This tutorial's code can be found at `LINGO/tutorial/hu_tutorial.ipynb` and will walk through the **lineage origin prediction task,** which involves predicting the lineage origin of an individual cell from its transcriptomic profile.
...
```python
data_path = '/home/User/LINGO/data/Hu_2022_NatureGenetics.h5ad'
...
```python
from utilities_fate_prediction import _parse_timepoint_value
