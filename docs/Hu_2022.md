...
The example will walk through the **lineage origin prediction task,** which involves predicting the lineage origin of an individual cell from its transcriptomic profile.
